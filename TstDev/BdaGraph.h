...
private:
	...
	HRESULT THBDA_IOControl( DWORD  dwIoControlCode,
		LPVOID lpInBuffer,
		DWORD  nInBufferSize,
		LPVOID lpOutBuffer,
		DWORD  nOutBufferSize,
		LPDWORD lpBytesReturned);
	HRESULT THBDA_IOCTL_CHECK_INTERFACE_Fun(void);
	HRESULT THBDA_IOCTL_SET_LNB_DATA_Fun(LNB_DATA *pLNB_DATA);
	HRESULT THBDA_IOCTL_GET_LNB_DATA_Fun(LNB_DATA *pLNB_DATA);
	HRESULT THBDA_IOCTL_SET_DiSEqC_Fun(DiSEqC_DATA *pDiSEqC_DATA);
	HRESULT THBDA_IOCTL_GET_DiSEqC_Fun(DiSEqC_DATA *pDiSEqC_DATA);
};
