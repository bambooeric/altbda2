...
#define DEFAULT_FREQUENCY_C		0
#define DEFAULT_FREQUENCY_S		0
#define DEFAULT_FREQUENCY_T		0
#define DEFAULT_SYMBOLRATE_C	0
#define DEFAULT_SYMBOLRATE_S	0
#define DEFAULT_SYMBOLRATE_T	0
